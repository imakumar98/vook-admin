...
function (_Component) {
  ...
  function Edit(props) {
    ...
    _this.removeImage = _this.removeImage(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(Edit, [{
    ...
    value: function removeImage(e) {
      console.log(e.target); // var imageToRemove = e.target.getAttribute('value');
...
//# sourceMappingURL=edit.js.068c476586bccec693aa.hot-update.js.map