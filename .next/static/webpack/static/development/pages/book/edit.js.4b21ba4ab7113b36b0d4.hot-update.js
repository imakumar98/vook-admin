  ...
  _createClass(Edit, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var fetch, res, book, tags, images, publisher, index, i;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                console.log(publisher.childNodes[0].value);
                publisher.childNodes.length;

                for (i = 0; i <= publisher.childNodes.length; i++) {
                  if (book.publisher.name == publisher.childNodes[i].value) {
                    index = i;
                  }
                }

                publisher.selectedElement = index; // const values = publisher.childNodes.map((option)=>{
                //     return option.value;
                // })
                // console.log(values);
...
//# sourceMappingURL=edit.js.4b21ba4ab7113b36b0d4.hot-update.js.map