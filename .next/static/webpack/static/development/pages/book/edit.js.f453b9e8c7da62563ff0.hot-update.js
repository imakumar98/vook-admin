          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                console.log(publisher.childNodes[1].value); // publisher.childNodes.length
                // var index;
                // for(var i=0;i<=publisher.childNodes.length;i++){
                //     if(book.publisher.name==publisher.children[i].value){
                //         index = i
                //     }
                // }
                // publisher.selectedElement = index;
                // const values = publisher.childNodes.map((option)=>{
                //     return option.value;
                // })
                // console.log(values);
...
//# sourceMappingURL=edit.js.f453b9e8c7da62563ff0.hot-update.js.map